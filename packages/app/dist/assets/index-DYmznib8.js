 ...
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rt=globalThis,ke=Rt.ShadowRoot&&(Rt.ShadyCSS===void 0||Rt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Pe=Symbol(),dr=new WeakMap;let es=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==Pe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(ke&&t===void 0){const s=e!==void 0&&e.length===1;s&&(t=dr.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&dr.set(e,t))}return t}toString(){return this.cssText}};const zi=i=>new es(typeof i=="string"?i:i+"",void 0,Pe),O=(i,...t)=>{const e=i.length===1?i[0]:t.reduce(((s,r,o)=>s+(n=>{if(n._$cssResult$===!0)return n.cssText;if(typeof n=="number")return n;throw Error("Value passed to 'css' function must be a 'css' function result: "+n+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(r)+i[o+1]),i[0]);return new es(e,i,Pe)},Ni=(i,t)=>{if(ke)i.adoptedStyleSheets=t.map((e=>e instanceof CSSStyleSheet?e:e.styleSheet));else for(const e of t){const s=document.createElement("style"),r=Rt.litNonce;r!==void 0&&s.setAttribute("nonce",r),s.textContent=e.cssText,i.appendChild(s)}},ur=ke?i=>i:i=>i instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return zi(e)})(i):i;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,z={styles:mo};var go=Object.defineProperty,zt=(i,t,e,s)=>{for(var r=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=n(t,e,r)||r);return r&&go(t,e,r),r};const Ue=class Ue extends C{constructor(){super(...arguments),this.loggedIn=!1,this.isFavorited=!1,this._authObserver=new A(this,"lum:auth")}render(){return p`
        ...
        <div class="modal" @click="${s=>s.stopPropagation()}">
          ...
          <div class="modal-content">
            <mu-form
              ...
              ${Object.entries(t).map(([s,r])=>s==="imageSrc"||s==="name"||s==="_id"||s=="number"?null:e(s,r))}
            </mu-form>
          </div>
        </div>
      </div>
        ...
        <div class="modal" @click="${s=>s.stopPropagation()}">
          ...
          <div class="modal-content">
            <mu-form
              .init=${t}
              @mu-form:submit=${this.handleSubmit}>
              ${Object.entries(t).map(([s,r])=>s==="imageSrc"||s==="_id"||s==="teamName"?null:s==="drivers"&&Array.isArray(r)?p`
                    <fieldset>
                      <h3>Drivers</h3>
                      ${r.map((o,n)=>p`
    ...
    `];let kt=He;ns([y()],kt.prototype,"api");ns([y()],kt.prototype,"redirect");var So=Object.defineProperty,ee=(i,t,e,s)=>{for(var r=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=n(t,e,r)||r);return r&&So(t,e,r),r};const qe=class qe extends C{constructor(){super(...arguments),this.formData={},this.redirect="/"}get canSubmit(){return!!(this.api&&this.formData.username&&this.formData.password&&this.formData.confirmPassword&&this.formData.password===this.formData.confirmPassword)}handleChange(t){const e=t.target,s=e?.name,r=e?.value,o=this.formData;switch(s){case"username":this.formData={...o,username:r};break;case"password":this.formData={...o,password:r};break;case"confirmPassword":this.formData={...o,confirmPassword:r};break}}handleSubmit(t){t.preventDefault(),this.canSubmit&&fetch(this?.api||"",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({username:this.formData.username,password:this.formData.password})}).then(e=>e.status!==201?e.json().then(s=>{throw s.error||"Signup failed"}):e.json()).then(e=>{const{token:s}=e,r=new CustomEvent("auth:message",{bubbles:!0,composed:!0,detail:["auth/signin",{token:s,redirect:this.redirect}]});console.log("dispatching message",r),this.dispatchEvent(r)}).catch(e=>{console.log(e),this.error=typeof e=="string"?e:e.toString()})}render(){return p`
      <form
        @change=${t=>this.handleChange(t)}
        @submit=${t=>this.handleSubmit(t)}
      >
    ...
    `];let Z=qe;ee([E()],Z.prototype,"formData");ee([y()],Z.prototype,"api");ee([y()],Z.prototype,"redirect");ee([E()],Z.prototype,"error");var ko=Object.defineProperty,as=(i,t,e,s)=>{for(var r=void 0,o=i.length-1,n;o>=0;o--)(n=i[o])&&(r=n(t,e,r)||r);return r&&ko(t,e,r),r};const Ve=class Ve extends C{constructor(){super(...arguments),this.api="/auth/register",this.redirect="/app"}connectedCallback(){super.connectedCallback(),customElements.get("signup-form")||customElements.define("signup-form",Z)}render(){return p`
    ...
    `},{path:"/app",view:()=>p`
        ...
        <deck-element src="/api/cards/category/mainPages"></deck-element>`},{path:"/",redirect:"/app"}];Ot({"mu-auth":w.Provider,"mu-history":Ms.Provider,"mu-switch":class extends ki.Element{constructor(){super(Ro,"lum:history","lum:auth")}},"mu-store":class extends Us.Provider{constructor(){super(eo,to,"lum:auth")}},"card-element":T,"deck-element":J,"driver-element":dt,"favorites-element":Bt,"header-element":R,"login-element":kt,"signup-element":Pt,"drivers-view":ls,"teams-view":cs,"tracks-view":hs,"favorites-view":Le,"team-element":ut,"track-element":pt});
